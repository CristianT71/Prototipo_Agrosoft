...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const btnHamburguesa = document.querySelector('.boton-hamburguesa button');
    ...
    if (iconoCerrar2) {
        iconoCerrar2.addEventListener('click', function () {
            menuLateral.classList.toggle('colapsado');
            const contenido = document.querySelector('.contenido-principal');
            const barraTop = document.querySelector('.barra-superior');
            if (menuLateral.classList.contains('colapsado')) {
                contenido.style.marginLeft = '63px';
                barraTop.style.left = '63px';
                barraTop.style.width = 'calc(100% - 63px)';
            } else {
                contenido.style.marginLeft = '255px';
                barraTop.style.left = '255px';
                barraTop.style.width = 'calc(100% - 255px)';
            }
        });
    }

    function ajustarIconoMenu() {
        if (!iconoCerrar || !iconoCerrar2) return;
        if (window.innerWidth <= 430) {
            iconoCerrar.style.display = 'flex';
            iconoCerrar2.style.display = 'none';
        } else {
            iconoCerrar.style.display = 'none';
            iconoCerrar2.style.display = 'flex';
        }
    }
